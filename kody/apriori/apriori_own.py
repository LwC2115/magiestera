...
transactions = [
    {'mleko', 'chleb', 'maslo', 'jajka'},       
    {'mleko', 'chleb', 'maslo', 'jajka'},       
    {'mleko', 'chleb', 'maslo', 'jajka', 'ser'}, 
    {'mleko', 'chleb', 'maslo', 'jajka', 'kawa'},
    {'chleb', 'maslo', 'ser'},                 
    {'mleko', 'jajka', 'kawa'},               
    {'chleb', 'maslo', 'kawa'},                
    {'mleko', 'chleb', 'maslo'},               
...
import time
start=time.time()
zbiory= apriori_own(transactions,0.4)
end=time.time()

for itemset, support in zbiory.items():
     print(f"{set(itemset)} -> {support}")
print(f"czas wyoknania {end - start:.2f} sekund!")
